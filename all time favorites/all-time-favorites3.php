...
<body>
	...
	<div class="page-menu">
		...
		<div class="header-box">
			<h1 class="page-header">All time favorites</h1>
			<p class="page-subheader">Generated by individual rating of each anime</p>
		</div>
	...
	<div class="an-numb-box">
		<p class="an-numb-subheader">
			<span class="an-numb">183</span>
			Anime
		</p>
		<p class="sort-anime selected">Popular</p>
		<p class="sort-anime">Unpopular</p>
		<div class="search-sim">
						<label class="sim-text" for="sim"><input class="sim-checkbox" id="sim" type="checkbox">Unwatched</label>			
		</div>
	</div>
